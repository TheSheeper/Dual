...
//   Variables
    ...
    private static final String REGULAR = CUR_DIR+"/src/fonts/calibri.ttf";
    private static final String BOLD = CUR_DIR+"/src/fonts/calibrib.ttf";
...
//            Fuente general del documento
            ...
            //           Header y footer
            Image header = new Image(ImageDataFactory.create("src/imagenes/pdf/header_pdf.jpg"));
            Image footer = new Image(ImageDataFactory.create("src/imagenes/pdf/footer_pdf.jpg"));
...
//            Datos programa y alumno
    ...
    public static String generarFecha(){
        ...
        for(int i = 0; i < fecha.length(); i++){
            ...
            switch(num){
                case 0 -> anio += fecha.charAt(i);
                case 1 -> mes += fecha.charAt(i);
                case 2 -> dia += fecha.charAt(i);
            }
        }
...
//            Creacion del documento
            File file = new File(CUR_DIR+"/archivos_alumnos/imagenes.pdf");
